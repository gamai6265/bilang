...
namespace cn.sharesdk.unity3d {
    ...
    /// ShareSDK.
    /// </summary>
    public class ShareSDK : Singleton<ShareSDK> {
        private int reqID;
        //配置ShareSDK AppKey
        //注:此处区分仅为demo测试而区分，实际使用时可以不区分安卓或iOS
#if UNITY_ANDROID
        public string appKey = "13ff6143d76f9";
#elif UNITY_IPHONE
		public string appKey = "16bab3ea2de2c";
#endif
        public DevInfoSet devInfo = new DevInfoSet() {
            wechat = new WeChat()
        };
...
#if UNITY_ANDROID
            shareSDKUtils = new AndroidImpl();
#elif UNITY_IPHONE
			shareSDKUtils = new iOSImpl();
#endif
